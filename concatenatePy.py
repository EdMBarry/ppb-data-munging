...
data=os.listdir("H:\\02_Projects\\02_PPB-GRO-Batch\\04_Experiments\\01_IrradianceMeasurment\\data")
grid_width, grid_height = np.mgrid[78:390:1, 60:98:1] #dimensioned grid [mm]
data = list(map(int, data))
data = sorted(data,key=int)

spectrum=genfromtxt('H:\\02_Projects\\02_PPB-GRO-Batch\\04_Experiments\\01_IrradianceMeasurment\\data\\1\\1.IRR',skip_header=2,skip_footer=1,usecols=0)
